...
{
    public class MaintempController : Controller
    {
        string address = "http://localhost:57732/Dota2Stats/Maintemp/";
        ...
        public async Task<ActionResult> Index(int? page)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (Res.IsSuccessStatusCode)
                {
                    ...
                    var MaintempResponse = Res.Content.ReadAsStringAsync().Result;

                    //Deserializing the response recieved from web api and storing into the  list  
                    Maintemp = JsonConvert.DeserializeObject<List<Maintemp>>(MaintempResponse);
                ...
                return View(Maintemp.ToPagedList(pageIndex, pageSize));
            }
        }
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                if (Res.IsSuccessStatusCode)
                {
                    ...
                    //Deserializing the response recieved from web api and storing into the  list  
                    Maintemp = JsonConvert.DeserializeObject<Maintemp>(HeroResponse);
